...
interface PointHistoryQuerydsl {
    ...
    /**
     * @param eventTypes    이벤트 구분
     * @param sourceId 이벤트 id
     * @return 이벤트 구분에 맞는 이벤트 id로 적립된 포인트
     */
    Integer getPoint(final Set<PointHistory.EventType> eventTypes, final UUID sourceId);
     ...
     * @return 이벤트 구분에 맞는 이벤트 id로 적립된 포인트
     */
    Integer getPoint(final Set<PointHistory.EventType> eventTypes, final UUID sourceId, final Boolean pointOnly);
}
